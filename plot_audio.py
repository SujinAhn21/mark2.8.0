...
def plot_waveform_and_mel(path, save_dir=None, seed_value=42, mark_version="mark2.8.0"):
    set_seed(seed_value)
...
if __name__ == "__main__":
    test_audio_file = os.path.join(BASE_DIR, "data_wav", "construction_hammer_30.wav") 
